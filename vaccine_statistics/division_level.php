<?php
  $page_title = 'Division Statistics';
...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1>Division Level Statistics</h1>
      <hr>
      	<?php
      	$epi_year;
      	...
      	division.division_name, division.division_id,
        ...
        <thead>
        	...
        	?>
                <tbody>
                <tr>
                    <td class="text-left"><?php  echo $row['division_name']; ?></td>
                    ...
                    <?php
                    echo "<td class='text-right'>".'<a href=../vaccine_statistics/district_level.php?id='.$row['division_id'].'>VIEW</a>'. "</td>";
                    ?>
                </tr>
            <?php
            }
