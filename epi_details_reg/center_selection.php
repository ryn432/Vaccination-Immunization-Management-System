		          ...
		          <div class="jumbotron">
					...
					<?php
						...
						while ($row = $query_center_run->fetch_assoc())
						{
                            ...
                            ADD COLUMN ward_no INT,
                            ADD COLUMN epi_year INT;
						...
						echo "<br><br><small><strong>Notice: </strong>If there is no value on dropdown field then it is possible because, no EPI Schedule has been created for that EPI Center. Please contact with subdistrict health officer to resolve the issue.</small>";
						echo '</form>';
