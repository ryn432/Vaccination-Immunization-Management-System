...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
        ...
        while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
            $sqlInsertupa = "INSERT into subdistrict (subdistrict_ID,subdistrict_Name,District_ID) values ('" . $column[0] . "','" . $column[1] . "','" . $column[2] . "')";
...
<div id="page-wrapper">
   ...
   <div class="col-md-12">
    ...
    <h2 class="text-center">Import SubDistrict CSV File Into DB</h2>
    <hr>
    ...
    <div class="outer-scontainer">
            ...
            <form class="col-lg-12" action="" method="post"
                ...
                <div class="input-row">
                    <label class="control-label">Choose SubDistrict CSV File</label> <br>
        ...
        <br>
               <?php
            $sqlSelect = "SELECT * FROM subdistrict";
            $result = mysqli_query($conn, $sqlSelect);

            if (mysqli_num_rows($result) > 0) {
                ?>
            <table id='subdistrictTable' class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th class="text-left" width="20%">SubDistrict ID</th>
                    <th class="text-left" width="20%">SubDistrict Name</th>
...
<?php
                ...
                <tr>
                    ...
                    <td width="20%" class="text-left"><?php  echo $row['subdistrict_name']; ?></td>
