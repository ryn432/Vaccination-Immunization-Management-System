		        ...
		        <div class="row">
		          <div class="jumbotron">
					...
					<?php
						...
						echo "&nbsp;&nbsp;&nbsp;&nbsp;";
						echo '<a class="btn btn-warning" href="../change_center_scheduler/subdistrict_selection.php">PREVIOUS</a>';
						echo '</form>';
						...
						<script type="text/javascript">
		    				window.location = "../change_center_scheduler/year_selection.php";
						</script>
					<?php
						}
					?>
