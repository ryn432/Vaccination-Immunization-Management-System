        ...
        <div class="row">
          <div class="jumbotron">
            <div class="container">
              <h4 class="display-3">
              	<article>
              	You are going to create/rechange Automated EPI Schedule for <strong>Monday-Thursday</strong>
              ...
              <br>
              	<form method="post">
                	<?php include_once("../schedule_info/mr/mr_main.php"); ?>
            	</form>
            </div>
          </div>
        </div>
