...
$sqlDayOne = "SELECT Name FROM days WHERE days_id='1'";
...
$sqlDayTwo = "SELECT Name FROM days WHERE days_id='4'";
...
echo "<form method='post' action=''>";
echo '</br>' . "<strong>Saturday-Tuesday</strong> EPI Schedule is being created/rechanged for Year ".$epi_year.". To view/modification <button type='submit' name='click_here' class='btn btn-warning btn-xs'>Click Here</button>";
echo "</from>";
}
else
{
...
{
    $sqlFinal_AT="TRUNCATE TABLE at_schedule";
    $result_sqlFinal_AT = mysqli_query($conn, $sqlFinal_AT);
    
    $sql="INSERT INTO at_schedule (at_jan, at_feb, at_mar, at_apr, at_may, at_jun, at_jul, at_aug, at_sep, at_oct, at_nov, at_dec, ward_id, epi_year, schedule_id) SELECT at_jan, at_feb, at_mar, at_apr, at_may, at_jun, at_jul, at_aug, at_sep, at_oct, at_nov, at_dec, ward_id, epi_year, schedule_id FROM at_schedule_w1 UNION SELECT at_jan, at_feb, at_mar, at_apr, at_may, at_jun, at_jul, at_aug, at_sep, at_oct, at_nov, at_dec, ward_id, epi_year, schedule_id FROM at_schedule_w2 UNION SELECT at_jan, at_feb, at_mar, at_apr, at_may, at_jun, at_jul, at_aug, at_sep, at_oct, at_nov, at_dec, ward_id, epi_year, schedule_id FROM at_schedule_w3";
    $result = mysqli_query($conn, $sql);
?>
<script type="text/javascript">
    window.location = "../schedule_info/at_table_index.php";
</script> 
<?php
}
