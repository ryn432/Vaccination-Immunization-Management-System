...
$sqlDayOne = "SELECT Name FROM days WHERE days_id='3'";
...
$sqlDayTwo = "SELECT Name FROM days WHERE days_id='6'";
...
echo "<form method='post' action=''>";
echo '</br>' . "<strong>Monday-Thursday</strong> EPI Schedule is being created/rechanged for Year ".$epi_year.". To view/modification <button type='submit' name='click_here' class='btn btn-warning btn-xs'>Click Here</button>";
echo "</from>";
}
else
{
...
{
    $sqlFinal_MR="TRUNCATE TABLE mr_schedule";
    $result_sqlFinal_MR = mysqli_query($conn, $sqlFinal_MR);
    
    $sql="INSERT INTO mr_schedule (mr_jan, mr_feb, mr_mar, mr_apr, mr_may, mr_jun, mr_jul, mr_aug, mr_sep, mr_oct, mr_nov, mr_dec, ward_id, epi_year, schedule_id) SELECT mr_jan, mr_feb, mr_mar, mr_apr, mr_may, mr_jun, mr_jul, mr_aug, mr_sep, mr_oct, mr_nov, mr_dec, ward_id, epi_year, schedule_id FROM mr_schedule_w1 UNION SELECT mr_jan, mr_feb, mr_mar, mr_apr, mr_may, mr_jun, mr_jul, mr_aug, mr_sep, mr_oct, mr_nov, mr_dec, ward_id, epi_year, schedule_id FROM mr_schedule_w2 UNION SELECT mr_jan, mr_feb, mr_mar, mr_apr, mr_may, mr_jun, mr_jul, mr_aug, mr_sep, mr_oct, mr_nov, mr_dec, ward_id, epi_year, schedule_id FROM mr_schedule_w3";
    $result = mysqli_query($conn, $sql);
?>
<script type="text/javascript">
    window.location = "../schedule_info/mr_table_index.php";
</script> 
<?php
}
